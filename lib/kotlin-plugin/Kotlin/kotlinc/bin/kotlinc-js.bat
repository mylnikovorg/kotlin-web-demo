...
if "%_PROFILE_PRELOADER%"=="time" (
  "%_JAVACMD%" %_JAVA_OPTS% -cp "%_KOTLIN_HOME%\org.jetbrains.webdemo.lib\kotlin-preloader.jar" ^
    org.jetbrains.jet.preloading.Preloader "%_KOTLIN_HOME%\org.jetbrains.webdemo.lib\kotlin-compiler.jar;%_KOTLIN_HOME%\org.jetbrains.webdemo.lib\kotlin-runtime.jar" ^
